...
class QuickListTest {
    ...
    void whenSortByNameThenOk() {
        ...
        User user2 = new User(1, "33");
        User user3 = new User(3, "11");
        User user4 = new User(-4, "44");
        User user5 = new User(4, "66");
        User user6 = new User(6, "22");
        ...
        assertThat(result).containsExactly("11", "22", "33", "44", "55", "66");
    }
