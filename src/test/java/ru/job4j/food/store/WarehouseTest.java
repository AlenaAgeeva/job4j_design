...
class WarehouseTest {
    ...
    void whenExpirationFalse() {
        Food spoiled = new Meat(
                ...
                500.5,
                25.5);
        assertThat(new Warehouse().checkExpiration(spoiled)).isFalse();
    }
    ...
    void whenExpirationTrue() {
        Food goatMilk = new Milk(
                "goat milk",
                new GregorianCalendar(2025, 8, 10, 16, 16, 47),
                new GregorianCalendar(2024, 1, 2, 8, 16, 47),
                45.5,
                30.);
        assertThat(new Warehouse().checkExpiration(goatMilk)).isTrue();
    }
}